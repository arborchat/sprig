...
require (
	gioui.org v0.0.0-20201108183138-8b5c0d8b0ce2
	gioui.org/cmd v0.0.0-20201108183138-8b5c0d8b0ce2
	...
	git.sr.ht/~whereswaldon/events v0.0.0-20201107181310-f27bb25c0572
